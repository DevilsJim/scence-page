<template>
  <div class="map-card-box">
    ...
    <div class="imageTextShow">
      ...
      <!--单张图-->
      <div v-if="datumJson.styleType === 'm-default'" class="imgShow" :style="{backgroundImage: 'url(' +datumJson.mediaContent[0].matter+ ')'}"></div>
    </div>
    <!-- <div class="cont-embedded-box" v-if="datumJson.embedded && embedItem.matters.length" v-for="(embedItem, embedIndex) in datumJson.extendContents[0]" :key="embedIndex"> -->
